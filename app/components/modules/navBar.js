    ...
    <div className={navbar.content}>
        <ul className={navbar.navbarlist}>
            ...
            <ul className={navbar.navbarsociallist}>
                    <li className={navbar.navbarsocialitem}><a target="_blank" href="https://github.com/mkashima1" rel="noopener noreferrer"><img src="/circle-green.svg" alt= "enabled" width="5px"/> GITHUB</a></li>
